...
## タスクツールの概要  
<i class="fas fa-external-link-alt"></i> [システムタスクの自動化](https://access.redhat.com/documentation/ja-jp/red_hat_enterprise_linux/6/html/deployment_guide/ch-automating_system_tasks)  
...
<i class="fas fa-check-circle">daily</i>  
...
<i class="fas fa-check-circle">weekly</i>  
...
<i class="fas fa-check-circle">monthly</i>  
